...
@section('content')
    <div class="page-header">
        <h1 class="page-title">{{ __('admin.add_menu') }}</h1>
                    ...
                    <form action="{{ route($routePrefix.'.store') }}" method="POST">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="tipe" class="form-select @error('tipe') is-invalid @enderror" id="menuType" required>
                                        ...
                                        <option value="section" {{ old('tipe') == 'section' ? 'selected' : '' }}>Section</option>
                                        <option value="divider" {{ old('tipe') == 'divider' ? 'selected' : '' }}>Divider</option>
                                    </select>
                                    @error('tipe')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text" id="iconPreview"><i class="bi bi-circle"></i></span>
                                            <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon', 'bi-circle') }}" placeholder="bi-newspaper" id="iconInput">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="route" class="form-control @error('route') is-invalid @enderror" value="{{ old('route') }}" placeholder="admin.berita.index">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="route_pattern" class="form-control @error('route_pattern') is-invalid @enderror" value="{{ old('route_pattern') }}" placeholder="admin.berita.*">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="badge_model" class="form-control @error('badge_model') is-invalid @enderror" value="{{ old('badge_model') }}" placeholder="\App\Models\Kontak">
                                        @error('badge_model')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="badge_method" class="form-control @error('badge_method') is-invalid @enderror" value="{{ old('badge_method') }}" placeholder="unread">
                                        @error('badge_method')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="badge_class" class="form-select">
                                            <option value="bg-danger" {{ old('badge_class') == 'bg-danger' ? 'selected' : '' }}>Danger (Red)</option>
                                            <option value="bg-warning" {{ old('badge_class') == 'bg-warning' ? 'selected' : '' }}>Warning (Yellow)</option>
                                            <option value="bg-info" {{ old('badge_class') == 'bg-info' ? 'selected' : '' }}>Info (Blue)</option>
                                            <option value="bg-success" {{ old('badge_class') == 'bg-success' ? 'selected' : '' }}>Success (Green)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check mt-1" id="newTabField">
                                <input type="checkbox" name="buka_tab" class="form-check-input" id="bukaTab" value="1" {{ old('buka_tab') ? 'checked' : '' }}>
