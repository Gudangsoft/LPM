...
@section('title', __('admin.edit_document_type'))

@section('content')
    <div class="page-header">
        <h1 class="page-title">{{ __('admin.edit_document_type') }}</h1>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.jenis-dokumen.update', $jenisDokumen) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $jenisDokumen->nama) }}" required>
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" rows="3" class="form-control @error('deskripsi') is-invalid @enderror">{{ old('deskripsi', $jenisDokumen->deskripsi) }}</textarea>
                            @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="iconPreview"><i class="bi {{ $jenisDokumen->icon ?? 'bi-file-earmark' }}"></i></span>
                                        <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon', $jenisDokumen->icon) }}" placeholder="bi-file-earmark" id="iconInput">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="urutan" class="form-control @error('urutan') is-invalid @enderror" value="{{ old('urutan', $jenisDokumen->urutan) }}" min="0">
                                    @error('urutan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" name="is_active" class="form-check-input" id="isActive" value="1" {{ old('is_active', $jenisDokumen->is_active) ? 'checked' : '' }}>
