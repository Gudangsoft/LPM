...
@section('title', 'Tambah Jadwal AMI')

@section('content')
    <div class="page-header">
        <h1 class="page-title">Tambah Jadwal AMI</h1>
    ...
    <div class="card">
        <form action="{{ route('admin.ami.jadwal.store') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('periode_ami_id') is-invalid @enderror" id="periode_ami_id" name="periode_ami_id" required>
                            ...
                            <option value="{{ $p->id }}" {{ old('periode_ami_id', request('periode_id')) == $p->id ? 'selected' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_audit') is-invalid @enderror" id="tanggal_audit" name="tanggal_audit" value="{{ old('tanggal_audit') }}" required>
                        @error('tanggal_audit')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="time" class="form-control @error('waktu_selesai') is-invalid @enderror" id="waktu_selesai" name="waktu_selesai" value="{{ old('waktu_selesai', '12:00') }}" required>
                        @error('waktu_selesai')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('tempat') is-invalid @enderror" id="tempat" name="tempat" value="{{ old('tempat') }}" placeholder="Contoh: Ruang Rapat Lt. 2">
                    @error('tempat')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
