...
@section('title', __('admin.add_gallery'))

@section('content')
    <div class="page-header">
        <h1 class="page-title">{{ __('admin.add_gallery') }}</h1>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kategori') is-invalid @enderror" id="kategori" name="kategori" value="{{ old('kategori') }}" list="kategoriList">
                        ...
                        <div class="mb-3">
                            <label for="gambar" class="form-label">{{ __('admin.image') }} <span class="text-danger">*</span></label>
                            <input type="file" class="form-control @error('gambar') is-invalid @enderror" id="gambar" name="gambar" accept="image/*" required onchange="previewImage(this)">
                            @error('gambar')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
