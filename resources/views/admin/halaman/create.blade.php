...
@section('content')
    <div class="page-header">
        <h1 class="page-title">{{ __('admin.add_page') }}</h1>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tab-en">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('judul_en') is-invalid @enderror" id="judul_en" name="judul_en" value="{{ old('judul_en') }}">
                                    @error('judul_en')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control editor @error('konten_en') is-invalid @enderror" id="konten_en" name="konten_en" rows="15">{{ old('konten_en') }}</textarea>
                                    @error('konten_en')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
